...
type User struct {
	...
	CurrentLocationID *string           `bun:"current_location_id,nullzero" json:"current_location_id"`
	CreatedAt         time.Time         `bun:",nullzero,notnull,default:current_timestamp" json:"created_at"`
	UpdatedAt         time.Time         `bun:",nullzero,notnull,default:current_timestamp" json:"updated_at"`
	DeletedAt         *time.Time        `bun:"," json:"deleted_at,omitempty"`

	CurrentLocation *TujuanPengiriman `bun:"rel:belongs-to,join:current_location_id=id" json:"current_location,omitempty"`
}
